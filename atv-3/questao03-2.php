...
?>
    ...
    <div class="questoes">
            ...
            <div class="perguntas">
                <h3>Q2: Lorem ipsum dolor sit amet consectetur adipiscing elit?</h3>
                    <form id="questao" action="questao03-1.php" method="get">
                        <div class="resposta">
                            <ol type="A">
                                <a href="questao03-3.php?r1=<?php echo $r1 ?>&r2=1">
                                    <li>Sed do eiusmod tempor.</li>
                                </a>
                                <a id="resp" href="questao03-3.php?r1=<?php echo $r1 ?>&r2=2">
                                    <li>Incididunt ut labore.</li>
                                </a>
                                <a href="questao03-3.php?r1=<?php echo $r1 ?>&r2=3">
                                    <li>Et dolore magna aliqua.</li>
                                </a>
                                <a href="questao03-3.php?r1=<?php echo $r1 ?>&r2=4">
                                    <li>Enim nunc faucibus.</li>
                                </a>
                                <a href="questao03-3.php?r1=<?php echo $r1 ?>&r2=5">
